...
.. changelog:: 2.7.0
    ...
    .. change:: sending empty data in sse in js client
        ...
        Considering the EventSource "client" is not ok with it, and that it is so easy DX-wise to make the mistake not explicitly sending it, this change fixes it by defaulting to the empty-string
    ...
    .. change:: Allow reusable ``Router`` instances
        ...
        The router instance now gets deecopied when it is registered to another router.
